...
def attack_phase(attacking_player):
    ...
    stat = int(input(f"{attacking_player["name"]} choose your stat (1-6): "))
    attacker_guess = int(input("Enter your guess: "))
...
def defense_phase(attacking_player, defense_player, stat, attacker_guess):
    ...
    defender_guess = int(input(f"{defense_player["name"]} enter your guess to defend: "))
